    ...
    const portalOptions = [
        {
            to: '/login/admin',
            title: 'Admin Portal',
            description: 'Manage employess,departments,payroll and system configurations.',
            icon: ShieldIcon
        },
        {
            to: '/login/employee',
            title: 'Employee Portal',
            description: 'Access your profile, view payslips, submit leave requests, and manage attendance.',
            icon: UserIcon
        }
    ]
    return (
