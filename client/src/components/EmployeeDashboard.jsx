    ...
    <div className='animate-fade-in'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8'>
            {cards.map((card,index)=>(
                <div key={index} className='card card-hover p-5 sm:p-6 relative overdlow-hidden group flex items-center justify-between' >
                    <div>
                    ...
                    <card.icon className='size-10 p-2.5 rounded-lg bg-slate-100 text-slate-600 group-hover:bg-indigo-50 group-hover-indigo-600 transition-colors duration-200'/>
        ...
        <div className='flex flex-col sm:flex-row gap-3'>
            <Link className='btn-primary text-center inline-flex items-center justify-center gap-2' to="/attendance">
