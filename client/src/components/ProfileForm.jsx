           ...
           <div className='space-y-5'>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                <div>
                    ...
                    <input type="text"disabled value={`${initialData.firstName} ${initialData.lastName}`} className='bg slate-50 text-slate-400 cursor-not-allowed' />
                </div>
                 <div>
                    <label className='block text-sm font-medium text-slate-700 mb-2'>Email</label>
                    <input type="text"disabled value={initialData.email} className='bg slate-50 text-slate-400 cursor-not-allowed' />
                </div>
            ...
            <div>
                 ...
                 <textarea className={`resize-none ${initialData.isDeleted? "bg-slate-50 text-slate-400 cursor-not-allowed":""}`} name="bio" placeholder='Write a brief bio' defaultValue={initialData.bio || ""} disabled={initialData.isDeleted}/>
                 <p className='text-xs text-slate-400 mt-1.5'>This wil be displayed in your profile</p>
            </div>
