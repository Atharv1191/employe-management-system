  ...
  return (
    <div onClick={onClose} className='fixed inset-0 z-50 flex items-center justify-center p-4'>
        ...
        <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-md animate-fade-in' onClick={(e)=>e.stopPropagation()}>
            ...
            <form className='p-6 space-y-5' onSubmit={handleSubmit} action="">
                {message.text && (
                ...
                <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">Current Passowrd</label>
                    <input type="password" name='currentPassoword' required />
                   
                </div>
                 <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">New Passowrd</label>
