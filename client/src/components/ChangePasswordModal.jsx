...
const ChangePasswordModal = ({ open, onClose }) => {
    ...
    }  // ✅ Fix 1: closing bracket sahi jagah

    if (!open) return null;  // ✅ Fix 1: handleSubmit ke bahar

    return (
        <div onClick={onClose} className='fixed inset-0 z-50 flex items-center justify-center p-4'>
            <div className='absolute inset-0 bg-black/40 backdrop-blur-sm' />  {/* ✅ Fix 3: backdrop-blur-sm */}
            <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-md animate-fade-in' onClick={(e) => e.stopPropagation()}>
                ...
                <form className='p-6 space-y-5' onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <input type="password" name='currentPassword' required />  {/* ✅ Fix 2: typo fix */}
                    </div>
                    <div>
