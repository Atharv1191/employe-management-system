...
const EmployeeCard = ({ employee,onDelete,onEdit }) => {
  ...
  return (
    <div className='group relative card card-hover overflow-hidden'>
      ...
      {!employee.isDeleted && (
        <div className='absolute inset-0 bg-linear-to-t from-indigo-700/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity justify-center pb-6 gap-3 flex items-end'>
